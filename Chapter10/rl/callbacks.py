...
class TestLogger(Callback):
    ...
    def on_episode_end(self, episode, logs):
        ...
        self.file.write(str(variables[0])+ "," + str(variables[1])  + "," +  str(variables[2]) + "\n")
        self.file.flush()
...
class TrainEpisodeLogger(Callback):
    ...
    def on_episode_end(self, episode, logs):
        ...
        print(template.format(**variables))
        self.file.write(str(variables['step']) + "," + str(metrics_variables[1]) + "," + str(metrics_variables[3]) +
                        "," + str(metrics_variables[5])+ "\n")
        self.file.flush()
